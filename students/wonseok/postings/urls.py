...
from postings.views import CreateCommentView, CreatePostView, DeleteCommentView, DeletePostView, LikeCommentView, LikePostView, ReadCommentView, ReadPostView
